...
<form action="board-delete-db.jsp" method="post">
    ...
    <div style="text-align: center"><input type="submit" value="삭제하기"/>&nbsp;<input type="reset" value="다시쓰기"/></div>
</form>
    <div style="text-align: center"><img src="image/green_tree.gif" alt="tree"><a href="board-read.jsp?id=<%=id%>">삭제 취소</a></div>
</body>
</html>
